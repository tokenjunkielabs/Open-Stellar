...
import { disputeTaskOffer, TaskOfferLifecycleError } from "@/lib/task-offers/lifecycle"
...
export async function POST(req: Request, context: RouteContext) {
  ...
  try {
    const offer = disputeTaskOffer(decodeURIComponent(id), actorFromRequest(req))
    return NextResponse.json(
      { ok: true, offer, disputeTx: offer.disputeTx },
